...
/**
 * Record implementation of {@link StringExpression}.
 *
 * @param left
 ...
 */
public record StringExpressionR(DaxExpression left, StringOperator operator, DaxExpression right)
        implements StringExpression {

    public StringExpressionR {
